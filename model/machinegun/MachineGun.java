...
public class MachineGun extends GameFigure {
    ...
    Color color;
    int state;
    MachineGunAnimStrategy animStrategy;

    public MachineGun(int tx, int ty) {
        ...
        animStrategy = new MachineGunAnimShooting(this);
    }
    ...
    private void updateState() {
        if (state == STATE_SHOOTING) {
            if (hitCount > 0 || target.distance(location) <= 3.0) {
                ...
                animStrategy = new MachineGunAnimExploding(this);
            }
