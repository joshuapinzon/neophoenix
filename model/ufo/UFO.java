...
public class UFO extends GameFigure implements Subject {
    ...
    public void render(Graphics2D g2) {
        ...
        g2.setColor(color_2);
        g2.fillOval((int)(location.x + width - 55), (int)(location.y + height - 24), (width/2) - 13, (width/2) - 13);
        //g2.fillOval((int)(location.x + width - 45), (int)(location.y + height - 24), (width/2) - 13, (width/2) - 13);
        g2.fillOval((int)(location.x + width - 35), (int)(location.y + height - 24), (width/2) - 13, (width/2) - 13);
    }
