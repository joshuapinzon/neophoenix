...
public class VitalityWave extends GameFigure {

    public static final int UNIT_MOVE = 5;
    public static final int INIT_MISSILE_SIZE = 5;
    public static final int MAX_MISSILE_SIZE = 300;
    ...
    Color color;
    int state;
    VitalityWaveAnimStrategy animStrategy;

    public VitalityWave(int tx, int ty) {
        ...
        animStrategy = new VitalityWaveAnimShooting(this);
    }
    ...
    private void updateState() {
        if (state == STATE_SHOOTING) {
            if (hitCount > 0 || target.distance(location) <= 3.0) {
                ...
                animStrategy = new VitalityWaveAnimExploding(this);
            }
